...
import { UserCheck, Building, BadgeCheck, FileClock, KeyRound } from 'lucide-react';
import { RoleGuard } from '@/routes/RoleGuard';
import { UsersPage } from './UsersPage';
import { DepartmentsPage } from './DepartmentsPage';
import { PositionsPage } from './PositionsPage';
import { ActivityLogsPage } from './ActivityLogsPage';
import { PasswordHistoryPage } from '@/features/system/pages/PasswordHistoryPage';
...
const tabs = [
  ...
  { id: 'password-history', label: 'Lịch sử đổi mật khẩu', icon: KeyRound, permission: 'system:user:view' },
      ...
      <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-800 pb-3">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            Quản lý hồ sơ nhân viên, cơ cấu phòng ban, chức danh và nhật ký hoạt động
          </p>
        </div>
      </div>
